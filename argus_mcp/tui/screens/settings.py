...
from argus_mcp.tui.widgets.registry_panel import RegistryManagerPanel
from argus_mcp.tui.widgets.server_connections_panel import ServerConnectionsPanel
