"""Multi-server connection manager for the Argus MCP TUI.

Manages a named collection of Argus server connections, persists them
to ``~/.config/argus-mcp/servers.json``, and tracks which server is
...
from argus_cli.tui.api_client import ApiClient
...
class ServerEntry:
    ...
    url: str
    token: str | None = None
    client: ApiClient | None = field(default=None, repr=False)
...
class ServerManager:
    ...
    * Provide helpers for connecting, disconnecting, add/remove.
    ...
    @property
    def active_entry(self) -> ServerEntry | None:
    ...
    @property
    def active_client(self) -> ApiClient | None:
    ...
    @classmethod
    def from_config(cls, config_path: str | None = None) -> ServerManager:
