...
an install button to add it to the Argus configuration.
"""
...
class InstallPanelWidget(Widget):
    ...
    selected_entry: reactive[ServerEntry | None] = reactive(None)
    ...
    def watch_selected_entry(self, entry: ServerEntry | None) -> None:
    ...
    def _update_detail(self, entry: ServerEntry | None) -> None:
