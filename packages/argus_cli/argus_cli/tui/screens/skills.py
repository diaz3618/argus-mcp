...
from argus_cli.tui._config_ops import resolve_config_path, trigger_reload
...
class SkillsScreen(ArgusScreen):
    ...
    def __init__(self, skill_manager: object | None = None, **kwargs: Any) -> None:
    ...
    def action_toggle_skill(self) -> None:
        ...
        if self._skill_manager is not None:
            try:
                from argus_mcp.skills.manager import SkillManager, SkillStatus
